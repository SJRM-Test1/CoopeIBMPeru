...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'CERTIFICADOSMONTOS'}}
})
export class Certificadosmontos extends Entity {
  @property({
    type: 'string',
    hidden: true,
    required: true,
  ...
  constructor(data?: Partial<Certificadosmontos>) {
    super(data);
  }
}

export interface CertificadosmontosRelations {
  // describe navigational properties here
}

export type CertificadosmontosWithRelations = Certificadosmontos & CertificadosmontosRelations;
