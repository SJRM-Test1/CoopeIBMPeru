...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'MAESTROPRESTAMOS'}}
})
export class Maestroprestamos extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Maestroprestamos>) {
    super(data);
  }
}

export interface MaestroprestamosRelations {
  // describe navigational properties here
}

export type MaestroprestamosWithRelations = Maestroprestamos & MaestroprestamosRelations;
