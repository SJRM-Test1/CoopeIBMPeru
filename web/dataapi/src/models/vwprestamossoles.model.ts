...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'VWPRESTAMOSSOLES'}}
})
export class Vwprestamossoles extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Vwprestamossoles>) {
    super(data);
  }
}

export interface VwprestamossolesRelations {
  // describe navigational properties here
}

export type VwprestamossolesWithRelations = Vwprestamossoles & VwprestamossolesRelations;
