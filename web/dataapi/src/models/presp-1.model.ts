...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'PRESP1'}}
})
export class Presp1 extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Presp1>) {
    super(data);
  }
}

export interface Presp1Relations {
  // describe navigational properties here
}

export type Presp1WithRelations = Presp1 & Presp1Relations;
