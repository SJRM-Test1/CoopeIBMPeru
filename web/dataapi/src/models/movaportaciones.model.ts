...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'MOVAPORTACIONES'}}
})
export class Movaportaciones extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Movaportaciones>) {
    super(data);
  }
}

export interface MovaportacionesRelations {
  // describe navigational properties here
}

export type MovaportacionesWithRelations = Movaportaciones & MovaportacionesRelations;
