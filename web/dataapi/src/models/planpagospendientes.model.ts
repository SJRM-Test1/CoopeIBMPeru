...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'PLANPAGOSPENDIENTES'}}
})
export class Planpagospendientes extends Entity {
  @property({
    type: 'number',
    required: true,
    length: 2,
  ...
  constructor(data?: Partial<Planpagospendientes>) {
    super(data);
  }
}

export interface PlanpagospendientesRelations {
  // describe navigational properties here
}

export type PlanpagospendientesWithRelations = Planpagospendientes & PlanpagospendientesRelations;
