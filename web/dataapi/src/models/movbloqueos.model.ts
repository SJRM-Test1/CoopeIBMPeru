...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'MOVBLOQUEOS'}}
})
export class Movbloqueos extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Movbloqueos>) {
    super(data);
  }
}

export interface MovbloqueosRelations {
  // describe navigational properties here
}

export type MovbloqueosWithRelations = Movbloqueos & MovbloqueosRelations;
