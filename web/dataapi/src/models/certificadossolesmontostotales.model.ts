...
@model({
  settings: {
    idInjection: false,
    db2: {schema: db2config.schema, table: 'CERTIFICADOSSOLESMONTOSTOTALES'}
  }
})
export class Certificadossolesmontostotales extends Entity {
  @property({
    type: 'string',
    hidden: true,
    required: true,
  ...
  constructor(data?: Partial<Certificadossolesmontostotales>) {
    super(data);
  }
}

export interface CertificadossolesmontostotalesRelations {
  // describe navigational properties here
}

export type CertificadossolesmontostotalesWithRelations = Certificadossolesmontostotales & CertificadossolesmontostotalesRelations;
