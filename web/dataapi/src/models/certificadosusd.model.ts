...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'CERTIFICADOSUSD'}}
})
export class Certificadosusd extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 15,
  ...
  constructor(data?: Partial<Certificadosusd>) {
    super(data);
  }
}

export interface CertificadosusdRelations {
  // describe navigational properties here
}

export type CertificadosusdWithRelations = Certificadosusd & CertificadosusdRelations;
