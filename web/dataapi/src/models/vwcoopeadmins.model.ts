...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'VWCOOPEADMINS'}}
})
export class Vwcoopeadmins extends Entity {
  @property({
    type: 'boolean',
    length: 1,
    // precision: ,
  ...
  constructor(data?: Partial<Vwcoopeadmins>) {
    super(data);
  }
}

export interface VwcoopeadminsRelations {
  // describe navigational properties here
}

export type VwcoopeadminsWithRelations = Vwcoopeadmins & VwcoopeadminsRelations;
