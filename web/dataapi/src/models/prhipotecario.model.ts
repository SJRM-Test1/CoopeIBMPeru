...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'PRHIPOTECARIO'}}
})
export class Prhipotecario extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Prhipotecario>) {
    super(data);
  }
}

export interface PrhipotecarioRelations {
  // describe navigational properties here
}

export type PrhipotecarioWithRelations = Prhipotecario & PrhipotecarioRelations;
