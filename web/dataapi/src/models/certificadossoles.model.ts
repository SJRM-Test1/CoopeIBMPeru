...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'CERTIFICADOSSOLES'}}
})
export class Certificadossoles extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 15,
  ...
  constructor(data?: Partial<Certificadossoles>) {
    super(data);
  }
}

export interface CertificadossolesRelations {
  // describe navigational properties here
}

export type CertificadossolesWithRelations = Certificadossoles & CertificadossolesRelations;
