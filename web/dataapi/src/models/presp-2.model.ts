...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'PRESP2'}}
})
export class Presp2 extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Presp2>) {
    super(data);
  }
}

export interface Presp2Relations {
  // describe navigational properties here
}

export type Presp2WithRelations = Presp2 & Presp2Relations;
