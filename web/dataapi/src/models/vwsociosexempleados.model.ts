...
@model({
  settings: {idInjection: false, db2: {schema: 'DLQ90141', table: 'VWSOCIOSEXEMPLEADOS'}}
})
export class Vwsociosexempleados extends Entity {
  @property({
    type: 'string',
    length: 1,
    // precision: ,
  ...
  constructor(data?: Partial<Vwsociosexempleados>) {
    super(data);
  }
}

export interface VwsociosexempleadosRelations {
  // describe navigational properties here
}

export type VwsociosexempleadosWithRelations = Vwsociosexempleados & VwsociosexempleadosRelations;
