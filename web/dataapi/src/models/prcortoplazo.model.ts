...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'PRCORTOPLAZO'}}
})
export class Prcortoplazo extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Prcortoplazo>) {
    super(data);
  }
}

export interface PrcortoplazoRelations {
  // describe navigational properties here
}

export type PrcortoplazoWithRelations = Prcortoplazo & PrcortoplazoRelations;
