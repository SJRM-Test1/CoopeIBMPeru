...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'PRAUTOMOVIL'}}
})
export class Prautomovil extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Prautomovil>) {
    super(data);
  }
}

export interface PrautomovilRelations {
  // describe navigational properties here
}

export type PrautomovilWithRelations = Prautomovil & PrautomovilRelations;
