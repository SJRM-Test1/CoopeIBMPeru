...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'MOVMISCELANEOS'}}
})
export class Movmiscelaneos extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Movmiscelaneos>) {
    super(data);
  }
}

export interface MovmiscelaneosRelations {
  // describe navigational properties here
}

export type MovmiscelaneosWithRelations = Movmiscelaneos & MovmiscelaneosRelations;
