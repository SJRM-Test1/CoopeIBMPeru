...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'CTSUSDMONTOS'}}
})
export class Ctsusdmontos extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 15,
  ...
  constructor(data?: Partial<Ctsusdmontos>) {
    super(data);
  }
}

export interface CtsusdmontosRelations {
  // describe navigational properties here
}

export type CtsusdmontosWithRelations = Ctsusdmontos & CtsusdmontosRelations;
