...
@model({settings: {idInjection: false, db2: {schema: db2config.schema, table: 'PRPS'}}})
export class Prps extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Prps>) {
    super(data);
  }
}

export interface PrpsRelations {
  // describe navigational properties here
}

export type PrpsWithRelations = Prps & PrpsRelations;
