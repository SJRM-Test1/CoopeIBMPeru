...
@model({
  settings: {idInjection: false, db2: {schema: db2config.schema, table: 'PRACADEMICO'}}
})
export class Pracademico extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 5,
  ...
  constructor(data?: Partial<Pracademico>) {
    super(data);
  }
}

export interface PracademicoRelations {
  // describe navigational properties here
}

export type PracademicoWithRelations = Pracademico & PracademicoRelations;
