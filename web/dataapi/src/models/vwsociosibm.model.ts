...
@model({
  settings: {idInjection: false, db2: {schema: 'DLQ90141', table: 'VWSOCIOSIBM'}}
})
export class Vwsociosibm extends Entity {
  @property({
    type: 'string',
    length: 1,
    // precision: ,
  ...
  constructor(data?: Partial<Vwsociosibm>) {
    super(data);
  }
}

export interface VwsociosibmRelations {
  // describe navigational properties here
}

export type VwsociosibmWithRelations = Vwsociosibm & VwsociosibmRelations;
